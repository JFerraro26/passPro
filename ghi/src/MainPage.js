...
function MainPage() {
    ...
    const events = useSelector(
        (state) => state.rootReducer?.eventList.eventList
    );
                ...
                <div className="grid grid-cols-5">
                    ...
                    <div className="flex justify-evenly col-start-1 col-span-5 mt-12">
                        <button onClick={() => goToEventsList("sport")}>
                            <div className="w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 relative ease-in-out duration-200 hover:scale-110 hover:drop-shadow-xl">
                                <img
