  ...
  return (
    <div className="flex flex-wrap justify-center">
      <div className="w-6/12 sm:w-4/12 px-4">
        <h1 style={{ marginBottom: "10px" }} className="text-3xl text-center">
          My Profile
        </h1>
      ...
      <div className="w-6/12 sm:w-8/12 mx-auto mt-10 px-4">
        ...
        <div className="flex flex-col bg-blue-200 p-4 rounded-lg w-96 h-60 mx-auto">
          <div className="">
            {myEvents.length === 0 || myEvents.sales.length === 0 ? (
              <>
                <p className="text-center">You do not have any events yet</p>
                <Link
      ...
      <div className="w-6/12 sm:w-8/12 m-0-auto">
        ...
        {manageEventClicked ? <EventManager myEvents={myEvents} /> : null}
