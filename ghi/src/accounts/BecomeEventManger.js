                    ...
                    <div className="m-16 grid grid-cols-5 grid-rows-5">
                        <div className="bg-orange-100 flex flex-col col-start-2 col-span-3 row-start-1 row-span-3 border-4 border-blue-500 rounded-2xl mt-16">
                            <div className="m-8">
                                ...
                                <p className="mt-4">
                                    Agreement Regarding Allocation of Sales
                                    Proceeds. This Agreement is made between{" "}
                                    {account.username} and PassPro Inc,
                                    collectively referred to as the "Parties,"
                                    for the purpose of defining the allocation
                                    of sales proceeds generated through events
                                    managed by the Event Manager.
                                </p>
                                <br></br>
                                <h1>Allocation of Sales Proceeds:</h1>
                                <p>
                                    a. The Event Manager agrees to allocate 5%
                                    of all sales proceeds generated from events
                                    managed by them to PassPro Inc. b. The
                                    allocation will be based on the net sales
                                    proceeds after deducting any applicable
                                    taxes, fees, and expenses incurred in the
                                    event management process.
                                </p>
                                <br></br>
                                <h1>Payment Terms</h1>
                                <p>
                                    a. The Event Manager shall remit the
                                    allocated amount to the Beneficiary at point
                                    of purchase. b. The payment shall be
                                    deducted from sale, unless otherwise agreed
                                ...
                                <p>
                                    ...
                                    unless terminated by either Party. b. Upon
                                    termination, the Event Manager shall fulfill
                                    any outstanding payment obligations up to
                                    the date of termination.
                                </p>
                                <br></br>
                                <h1>Confidentiality:</h1>
                                <p>
                                    a. The Parties agree to maintain the
                                    confidentiality of all financial and
                                    sales-related information shared in relation
                                    to this Agreement. This Agreement shall be
