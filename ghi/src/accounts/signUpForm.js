        ...
        <div className="bg-blue-500 px-6 py-4 rounded-xl">
          <form className="grid-cols-2" onSubmit={(e) => handleSubmit(e)}>
                      ...
                      <div className="flex">
                        ...
                        <span className="ml-auto">
                          ...
                          >
                            <title>Close</title>
                            <path
                              onClick={(e) => setInvalidCredentials(false)}
            ...
            <div className="flex justify-end">
              <button
                className=" mt-3 w-full px-4 py-2 text-lg font-semibold text-white transition-colors duration-300 hover:bg-green-600 rounded-md shadow bg-green-500 focus:outline-none focus:ring-blue-200 focus:ring-4"
                type="submit"
              >
                Create Account
              </button>
        ...
        >
          ...
          <div>
            ...
            <ul className="mt-1.5 ml-4 list-disc list-inside">
              ...
              <li>Avatar Image must be a url but it is optional.</li>
            </ul>
          </div>
        </div>
      ) : null}
